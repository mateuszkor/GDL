...
I add Squirrel as a real dataset because it is a widely used heterophily benchmark and it is discussed in the target paper. It provides a realistic setting where low pass biases can fail, which makes it a direct test of the diagnostic beyond homophilic benchmarks like Cora and CiteSeer. % [Source: Ours]
